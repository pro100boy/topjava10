...
public class MealsUtil {
    public static void main(String[] args) {
        List<Meal> meals = Arrays.asList(
                new Meal(1, LocalDateTime.of(2017, Month.MAY, 30, 10, 0), "Завтрак", 500),
                new Meal(2, LocalDateTime.of(2016, Month.MAY, 30, 13, 0), "Обед", 1000),
...
//                      Collectors.toMap(Meal::getDate, Meal::getCalories, Integer::sum)
        ...
        /*caloriesSumByDate.entrySet().stream()
                .sorted(Map.Entry.<LocalDate, Integer>comparingByKey());*/
